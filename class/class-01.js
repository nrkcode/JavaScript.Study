...
// const fruits = ["사과", "바나나", "체리"]; // 객체 리터럴 방식으로 배열 생성
const fruits = new Array("사과", "바나나", "체리"); // 생성자 방식으로 배열 생성
console.log(fruits);
 ...
 * 우리가 그동안 생성자 함수를 사용하지 않고, 각각의 데이터를 만든 것은
 * 더 쉽게 만들 수 있게 각각의 리터럴 방식으로 만들었을 뿐입니다.
 */
...
const user = {
    ...
    // 속성 뒤에 있는 콜론(:) 기호와 function 키워드를 생략할 수 있다고 배웠습니다.
};
